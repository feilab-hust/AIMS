    ...
    def __init__(
        ...
        **kwargs
        ...
        self.patch_embed = ConvTokenizer(
            in_chans=channels, embed_dim=embed_dim, norm_layer=norm_layer
        )
        ...
        self.head = nn.Sequential(
            ...
            nn.Linear(self.num_features, 5) if num_classes > 0 else nn.Identity(),
        )
...
@MODEL_REGISTRY.register('dinat')
class DiNAT(NAT):
    '''
    DiNAT is NAT with dilation
    '''
